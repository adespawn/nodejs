...
class MappingAddressTranslator extends AddressTranslator {
    ...
    /**
     * @param {Map<_nodeNet.SocketAddress, _nodeNet.SocketAddress>} mapping Map of addresses in the address:port format to be translated.
     * The if present as a key in the map, the address will be translated to the value present in the map.
    ...
    /**
     * @package
     * @returns {Array<_nodeNet.SocketAddress>}
     */
