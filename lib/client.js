...
class Client extends events.EventEmitter {
    ...
    async #rustyPaged(query, params, execOptions, pageState) {
        ...
        let innerClient = this.rustClient;
        /**
         * @param {Array<rust.PagingStateResponseWrapper|rust.QueryResultWrapper>} result
         * Tuple of page state response and query result
         * @returns {Array<rust.PagingStateResponseWrapper|ResultSet>}
         * Tuple of page state response and result set
         */
