...
const { bigintToLong, ensure32SignedInteger, ensure64SignedInteger } = require("../../lib/new-utils");
...
describe("ensure32SignedInteger", function () {
    it("should accept valid 32-bit signed integers", function () {
        const validValues = [
            ...
            1000000,
            -1000000,
            0x7fffffff,  // max int32: 2147483647
            -0x80000000, // min int32: -2147483648
        ];
